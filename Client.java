	...
	public Socket connetti() {
		try {
			System.out.println("Provo a connettermi al server...");
			 ...
			 mioSocket = new Socket(InetAddress.getLocalHost(), porta); //connessione al socket --> il socket lo registriamo nella variabile server, necessario per la comunicazione
